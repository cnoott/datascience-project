...
```{r}
sleep_stress = read.csv("C:/Users/shada/Documents/UH/Spring 2022/Math 4322 - Data Science and Machine Learning/Group Project/project/SleepStress.csv",sep=",", header=TRUE)
sleep_stress
```
