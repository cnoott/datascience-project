---
title:  \Huge\textbf{The Realation of Stress and Sleep}
author: 
...
We set a loop to run 10 times and set the seed to the ith iteration. For each iteration, we did a 80/20 training and testing split. We then ran the random forest model with the training set. Then we ran the model with the test data. (EXPLAIN THE MEANS HERE)
